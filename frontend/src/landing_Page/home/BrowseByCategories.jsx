...
function BrowseByCategories() {
    return (
        <div className="wrap mt-5">
            ...
            <div className="grid">
                <Link to='/acrepair' className='text-decoration-none'>
                <div className="tile ">
                ...
                <Link to='/cleaning' className='text-decoration-none'> 
                <div className="tile">
                    <div className="icon-circle">
                ...
                <Link to='/salon' className='text-decoration-none'>
                <div className="tile">
                    <div className="icon-circle">
                ...
                <Link to='/electrician' className='text-decoration-none'>
                <div className="tile">
                    <div className="icon-circle">
                ...
                <Link to='/painting' className='text-decoration-none'>
                <div className="tile">
                    <div className="icon-circle">
                ...
                <Link to='/appliancerepair' className='text-decoration-none'>
                <div className="tile">
                    <div className="icon-circle">
                ...
                <Link to='/pestcontrol' className='text-decoration-none'>
                <div className="tile">
                    <div className="icon-circle">
